...
<body class="min-h-screen overflow-hidden bg-slate-100 font-sans text-slate-900">
  <section class="relative flex h-screen items-center justify-center px-4 py-6">
    <!-- Kartu utama -->
    <div class="relative mx-auto flex w-full max-w-5xl overflow-hidden rounded-lg bg-white shadow-sm">

      <!-- KIRI: Form daftar -->
      <div class="flex w-1/2 flex-col justify-between border-r border-slate-100 px-8 py-10 sm:py-12">
        <div>
      ...
      <div
        class="flex w-1/2 flex-col bg-gradient-to-br from-sky-400 via-sky-500 to-sky-600 px-8 py-10 text-white sm:px-10 sm:py-12">
        <div class="max-w-sm">
          <h2 class="text-2xl font-bold">
            Belanja Efisien Kemana Saja
          </h2>
          <p class="mt-4 text-sm leading-relaxed text-white/90">
            Dengan berbagai kemudahan berbelanja di TP-PKK Marketplace, proses transaksi pembelanjaan menjadi cepat dan
            efisien
