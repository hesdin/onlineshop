...
<body class="bg-slate-100 font-sans text-slate-900">
  <section class="relative flex min-h-screen items-center justify-center px-4 py-16">
    {{-- KARTU UTAMA --}}
    <div
      class="relative mx-auto flex w-full max-w-5xl min-h-[70vh] md:min-h-[75vh] overflow-hidden rounded-lg bg-white shadow-sm">
        ...
        <div>
          ...
          <div class="mt-8 space-y-4">
            ...
            <a href="{{ route('register', ['role' => 'retail']) }}"
              ...
              <span class="flex h-14 w-14 flex-none items-center justify-center rounded-lg bg-teal-100 text-teal-600">
                {{-- icon keranjang --}}
            ...
            <a href="{{ route('register', ['role' => 'seller']) }}"
              class="flex items-center gap-4 rounded-lg bg-slate-50 px-5 py-4 transition hover:bg-slate-100">
              <span class="flex h-14 w-14 flex-none items-center justify-center rounded-lg bg-sky-100 text-sky-600">
                {{-- icon toko --}}
                <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7">
      ...
      <div class="flex w-1/2 flex-col bg-linear-to-br from-sky-400 via-sky-500 to-sky-600 px-8 py-14">
