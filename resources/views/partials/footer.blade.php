<footer class="mt-16 border-t border-slate-200 bg-white">
    <div class="container mx-auto grid gap-6 px-4 py-10 text-sm text-slate-500 md:grid-cols-4">
        <div>
            <p class="text-base font-semibold text-slate-900">PaDi UMKM</p>
            <p>Pasar Digital UMKM Indonesia</p>
            <p class="mt-3 text-xs text-slate-400">2020-2025 © Pasar Digital UMKM Indonesia</p>
        </div>
        <div>
            <p class="text-base font-semibold text-slate-900">Informasi</p>
        ...
        <div>
            <p class="text-base font-semibold text-slate-900">Hubungi Kami</p>
            <p class="mt-3 text-xs">Jl. Medan Merdeka Barat 12, Jakarta Pusat</p>
            <p class="text-xs">support@padiumkm.id</p>
