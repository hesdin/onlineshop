        ...
        <div class="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div class="space-y-5 text-sm">
                <div v-for="section in menuSections" :key="section.label" class="space-y-2">
                    ...
                    <nav class="space-y-1">
                        <a v-for="item in section.items" :key="item.key"
                            :class="[
                            ...
                            <span class="inline-flex h-5 w-5 items-center justify-center">
                                <svg v-if="item.icon === 'user'" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                ...
                                <svg v-else-if="item.icon === 'address'" width="18" height="18" viewBox="0 0 18 18"
                                ...
                                <svg v-else-if="item.icon === 'rekening'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                ...
                                <svg v-else-if="item.icon === 'pay'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                ...
                                <svg v-else-if="item.icon === 'list'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <svg v-else-if="item.icon === 'esign'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                ...
                                <svg v-else-if="item.icon === 'history'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                ...
                                <svg v-else-if="item.icon === 'review'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                ...
                                <svg v-else-if="item.icon === 'chat'" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
