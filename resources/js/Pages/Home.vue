                ...
                >
                    <div class="relative h-full overflow-hidden rounded-lg bg-slate-50" style="aspect-ratio: 1440 / 620;">
                        <template v-for="(banner, index) in heroBanners" :key="banner.label">
                            <a v-show="heroActive === index" class="block h-full w-full" :href="banner.url" target="_blank" rel="noopener">
                                <img
                                    :src="banner.image"
                                    :alt="banner.label"
                        ...
                        <div class="pointer-events-none absolute inset-0 flex items-center justify-between px-4">
                            <button
                                class="pointer-events-auto rounded-full bg-white/80 p-2 text-slate-700 shadow"
                        ...
                        <div class="absolute bottom-4 left-4 flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 shadow">
                            ...
                            <button
                                ...
                                @click="setHeroSlide(index); restartHero();"
                ...
                <div class="mt-5 flex flex-col gap-4 lg:flex-row lg:items-start">
                    ...
                    <div class="relative flex-1 overflow-hidden">
                            ...
                            >
                                <div class="-mx-4 -mt-4">
                                    <div class="relative h-40 overflow-hidden bg-slate-100">
                                        <div class="absolute left-2 top-2 rounded-md bg-sky-500 px-2 py-1 text-[11px] font-semibold uppercase text-white shadow">
                                            {{ product.badge }}
                                        </div>
                                            ...
                                            <span class="inline-flex h-4 w-4 items-center justify-center">
                                                <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#0092AC"
                                                    />
                                                    <path d="M5.92506 8.83C5.29006 8.895 4.81006 9.435 4.81006 10.075V11.69H7.68506V10.25C7.69006 9.205 7.07506 8.71 5.92506 8.83Z" fill="#0092AC" />
                                                </svg>
                                            </span>
                        ...
                        <div class="pointer-events-none absolute inset-y-0 left-0 right-0 flex items-center justify-between px-1">
                            <button
                                type="button"
                                @click="scrollCollection(index, -1)"
            ...
            <div class="space-y-3">
                ...
                >
                    <summary class="flex cursor-pointer items-center justify-between gap-4 px-6 py-4 text-lg font-bold">
                        <span>{{ faq }}</span>
                        <svg class="h-5 w-5 text-slate-700 transition-transform duration-200 group-open:rotate-180" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="m6 9 6 6 6-6" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </summary>
                    <div class="border-t border-slate-100 px-6 py-4">
                        <p class="text-sm text-slate-500">
                            Tim TP-PKK Marketplace siap membantu proses registrasi, verifikasi, hingga pengelolaan katalog produk Anda.
                        </p>
                    </div>
                </details>
            </div>
