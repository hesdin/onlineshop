...
const options = [
  ...
  {
    label: 'Penjual',
    description: 'Jual produk ke seluruh Indonesia',
    ...
    <div class="w-full max-w-5xl">
      <div class="bg-white rounded-md shadow-sm overflow-hidden lg:flex min-h-[600px]">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-sky-500 to-sky-600 p-10 flex-col justify-center">
          ...
          <div class="mt-10 space-y-4">
            <div class="flex items-center gap-3">
              ...
              <span class="text-sm text-white">Proses registrasi cepat & mudah</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                <svg class="h-4 w-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <span class="text-sm text-white">Transaksi aman & terpercaya</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                <svg class="h-4 w-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="lg:w-1/2 p-8 sm:p-10 flex flex-col justify-center">
          ...
          <!-- Title -->
          <h1 class="text-2xl font-bold text-slate-900">Pilih Jenis Akun</h1>
