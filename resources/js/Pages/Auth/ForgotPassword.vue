...
<template>
  ...
  <section class="relative flex min-h-screen items-center justify-center overflow-hidden bg-white text-slate-900">
    ...
    <div class="relative mx-auto flex w-full max-w-6xl flex-col items-center gap-10 px-6 py-12 lg:flex-row lg:items-stretch lg:gap-16 lg:py-16">
      <div class="flex flex-1 flex-col items-center justify-center text-center lg:items-start lg:text-left">
        <div class="max-w-md space-y-6">
          <img :src="heroIllustration" alt="Lupa kata sandi" class="mx-auto w-[240px] sm:w-[300px] lg:w-[340px] object-contain" />
          <div class="space-y-2">
      ...
      <div class="relative flex-1">
        <div class="relative z-10 ml-auto w-full max-w-xl rounded-xl border border-slate-100 bg-white p-8 sm:p-10 shadow-lg min-h-[420px]">
          <div class="mb-6 flex items-center justify-between gap-4">
            <Link :href="props.loginUrl || '/login'" class="flex h-10 w-10 items-center justify-center rounded-full p-1.5 text-slate-500 hover:bg-slate-100 hover:text-slate-700">
              <span class="text-xl font-semibold leading-none">&larr;</span>
            </Link>
            <div class="flex h-10 min-w-28 items-center justify-center rounded-xl border border-slate-200 text-[11px] font-bold text-sky-600 px-3">
              TP-PKK Marketplace
            </div>
          </div>
