                ...
                <CardContent class="space-y-4">
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <Input v-model="form.name" placeholder="Contoh: Nusantara Craft Hub"
            ...
            <Card class="border-slate-200">
                ...
                <CardContent class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input v-model="form.bumn_partner" placeholder="Contoh: PT PLN Persero"
                            :disabled="form.processing" />
                ...
                <CardContent class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <Textarea v-model="form.address_line" rows="3"
                            placeholder="Jl. Braga No. 10, Sumur Bandung, Kota Bandung" :disabled="form.processing" />
