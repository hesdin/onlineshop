          ...
          <div class="grid gap-4 md:grid-cols-2">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <Label>Slug</Label>
                <button type="button" class="text-xs text-slate-500 hover:text-slate-700" @click="regenerateSlug"
      ...
      <Card class="border-slate-200">
        ...
        <CardContent class="space-y-4">
          ...
          <div class="grid gap-4 md:grid-cols-3">
            ...
            <div class="space-y-2">
              <Label>Rating</Label>
              <Input v-model="form.rating" type="number" step="0.1" min="0" max="5" :disabled="form.processing" />
