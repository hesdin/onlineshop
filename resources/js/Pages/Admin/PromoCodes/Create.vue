...
<template>
  <div class="space-y-6">
    ...
    <Head title="Tambah Kode Promo" />

    <div class="flex items-center justify-between gap-3">
      <h1 class="text-xl font-bold tracking-tight text-slate-900">Tambah Kode Promo</h1>
      <Button variant="outline" size="sm" @click="router.visit('/admin/promo-codes')" :disabled="form.processing">
        Kembali
      </Button>
    </div>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Buat kode promo baru</CardDescription>
      </CardHeader>
      <CardContent>
        <form @submit.prevent="submit" class="space-y-4">
          <div class="space-y-2">
            <Label for="code">Kode</Label>
            <Input id="code" v-model="form.code" placeholder="FLASHSALE50" class="uppercase"
          ...
          <div class="space-y-2">
            ...
            <Input id="quota" type="number" v-model.number="form.quota" placeholder="Kosongkan untuk unlimited" />
          </div>
